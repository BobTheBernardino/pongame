...
function updateComputer() {
    ...
    const aiError = 25; // Add slight imperfection for balance

    // AI tries to follow the ball with some error
    if (computerCenter < ballCenterY - aiError) {
        computer.y += computer.speed;
    } else if (computerCenter > ballCenterY + aiError) {
        computer.y -= computer.speed;
    }
...
function updateBall() {
    ...
    // Score detection (ball goes out of bounds)
